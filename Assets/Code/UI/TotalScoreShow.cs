...
public class TotalScoreShow : MonoBehaviour
{
    ...
    public void Initialze(PlayerEvents playerEvents)
    {
        _playerEvents = playerEvents;
    }
    private void Start()
    {
        _playerEvents.OnSentPlayerScore.Subscribe(CreateAllPlayer);

        TotalScore = 0;
    }
    private void OnDestroy()
    {
        _playerEvents.OnSentPlayerScore.UnSubscribe(CreateAllPlayer);
    }
