...
public readonly struct EItem
{
    ...
    public static readonly EItem Basil = new("Basil");
    ...
    public static readonly EItem LongBeenCut = new("LongBeenCut");
    ...
    public static readonly EItem Mushroom = new("Mushroom");
    public static readonly EItem MushroomSlide = new("MushroomSlide");
    ...
    public static readonly EItem Tomato = new("Tomato");
    public static readonly EItem TomatoSlide = new("TomatoSlide");
